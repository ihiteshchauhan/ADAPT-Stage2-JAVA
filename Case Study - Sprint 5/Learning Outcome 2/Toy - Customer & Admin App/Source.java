...
class CustomerServiceImpl implements CustomerService{
    ...
    /*Comparator<Customer> nameComp=new Comparator<Customer>()
    {
...
public class Source {
    public static void main (String[] args) {
        ...
        switch(choice){
            case 1:String email=sc.nextLine();
                  ...
                  switch(custChoice){
                      case 1:cs.updateCustomer(c);
                             break;
                      case 2:int toyid=sc.nextInt();
                             cs.rent(toyid);
                             break;
                      case 3:System.out.println(CustomerServiceImpl.availedToys);
                             break;
                     default:System.out.println("Invalid choice");
                  }
                  break;
            case 2:String email2=sc.nextLine();
